                ...
                {true ? (
                  <div>
                    <Textarea
                      ...
                      placeholder="Paste examples of your brandbrandbrand's voiceapos;s voiceapos;s voice from website content, social media posts, or brand documents. These will help AI understand your writing style and tone."
                      rows={4}
