        ...
        <article>
          <header className="mb-10">
            ...
            <div className="mb-8 rounded-xl overflow-hidden">
              <img src="/cm-showcase.png" alt="Content Manager Showcase" className="w-full h-auto object-cover" />
            </div>
          ...
          <div className="border-t border-border/40 pt-8 mt-10 space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/blog/hootsuite-vs-content-manager" className="text-sm text-primary hover:underline">Content-Manager.io vs Hootsuite: The Full Comparison &rarr;</Link>
