...
export default function SocialTrends2026Page() {
  ...
  const schemaMarkup = {
    ...
    "@type": "BlogPosting",
    "headline": "The 18 Social Trends Reshaping 2026: An AI-Powered Strategy Guide",
    "author": { "@type": "Organization", "name": "Content-Manager.io" },
    "publisher": { "@type": "Organization", "name": "Content-Manager.io" },
    "description": "Comprehensive guide to B2B SaaS social media trends in 2026, focusing on interest-led discovery and the authenticity premium.",
  };
